...
const ArticleDetail = () => {
  ...
  const article = {
    ...
    content: `
      ...
      <h2 class="text-xl font-bold mt-6 mb-3">Why Choose SIP?</h2>
      ...
      <h2 class="text-xl font-bold mt-6 mb-3">How SIP Works?</h2>
      ...
      <h2 class="text-xl font-bold mt-6 mb-3">Benefits of SIP</h2>
      
      <p class="mb-4">SIP offers numerous advantages for investors:</p>
      
      <ol class="list-decimal list-inside mb-4">
        <li class="mb-2"><strong>Disciplined Investing:</strong> Regular investments build a habit of saving and investing.</li>
        <li class="mb-2"><strong>Rupee-Cost Averaging:</strong> Reduces the impact of market volatility over time.</li>
        <li class="mb-2"><strong>Start Small:</strong> Begin with amounts as low as ₹500 per month.</li>
        <li class="mb-2"><strong>Flexibility:</strong> Modify, pause or stop your SIP as per your financial situation.</li>
        <li class="mb-2"><strong>Power of Compounding:</strong> Early and regular investments benefit from compounding returns.</li>
      </ol>
      
      <h2 class="text-xl font-bold mt-6 mb-3">How to Start a SIP?</h2>
  ...
  return (
    <div className="pb-20">
      <div className="sticky top-0 bg-white z-10 shadow-sm">
        <div className="flex items-center justify-between p-4 border-b">
          ...
          <div className="flex space-x-3">
            <button onClick={handleBookmark} className="text-app-gray-900">
              <BookmarkPlus className="h-5 w-5" />
            </button>
            <button onClick={handleShare} className="text-app-gray-900">
      ...
      >
        ...
        >
          <Badge className="bg-app-light-green text-app-primary-green hover:bg-app-light-green border-app-light-green mb-2">
            {article.category}
          </Badge>
        ...
        <motion.div
          ...
          className="flex justify-between mb-8 pt-4 border-t"
        >
        ...
        >
          <div className="flex justify-between items-center mb-4">
            ...
            <button className="text-app-primary-green text-sm font-medium flex items-center">
          ...
          <div className="space-y-3">
            {article.relatedArticles.map((relatedArticle) => (
              ...
              >
                ...
                <div>
                  <h3 className="font-medium text-sm line-clamp-2">{relatedArticle.title}</h3>
